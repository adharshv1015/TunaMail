    ...
    def evaluate(
        ...
        for url in (
            ...
            is_recognized_safe = (
                ...
                or url.get("brand_relationship") in ("OFFICIAL_DOMAIN", "OFFICIAL_SUBDOMAIN", "AFFILIATED", "OFFICIAL_THIRD_PARTY")
                or any(e.get("type") in ("OFFICIAL_THIRD_PARTY_RESOURCE", "OFFICIAL_BRAND_SUBDOMAIN", "ESP_TRACKING_DOMAIN") for e in url.get("structured_evidence", []))
            )
