...
from src.ai.evidence_model import EvidenceItem
...
class AdaptiveIntelligenceEngine:
        ...
        if history_size > 0:
            ...
            if current_domain and normal_domains and current_domain not in normal_domains:
                anomalies.append({
                    ...
                    "severity": "HIGH",
                    "confidence": conf_val,
                    "explanation": f"Sender historically used {', '.join(normal_domains)} but now uses {current_domain}."
                })
    ...
    def analyze_url_infrastructure(self, urls: list, sender: str):
        ...
        for s in shared:
            anomalies.append({
                ...
                "severity": "HIGH",
                "confidence": 0.9,
                "explanation": f"URL infrastructure ({s['url']}) has been observed across {s['previous_senders']} other senders."
            })
    ...
    def generate_adaptive_evidence(self, sender: str, domain: str, current_auth: dict, current_verdict: str, current_score: int, urls: list):
        ...
        adaptive_result = {
            ...
            "history_confidence": sender_data.get("history_confidence", {}) if sender_data else {"level": "VERY_LOW", "score": 0.1},
