  ...
  return (
    <div className="flex flex-col gap-0 border-b border-[var(--tm-border)] bg-[var(--tm-surface-secondary)]">
      ...
      <div className="px-3 pb-2">
        {isServerSearch ? (
          ...
          <button
            ...
            className="w-full flex items-center justify-between text-[11px] font-semibold text-[var(--tm-text-secondary)] hover:text-[var(--tm-accent)] transition-colors px-1"
          >
      ...
      {showAdvanced && !isServerSearch && (
        <form onSubmit={handleRunSearch} className="mx-3 mb-3 p-3 rounded-xl border border-[var(--tm-border)] bg-[var(--tm-surface)] flex flex-col gap-2">
          ...
          <div className="flex gap-2 mt-1">
            <button type="submit" className="flex-1 px-3 py-1.5 text-[12px] font-semibold rounded-lg bg-indigo-500 text-white hover:bg-indigo-600 transition-colors">
              Search Gmail
            </button>
      ...
      {/* ── Inbox Fetch Controls (trigger backend reload) ── */}
      <div className="px-3 pb-2">
